  ...
  return (
    <>
      ...
      <div className="d-flex flex-wrap gap-4">
        ...
        <div
          className="card  mb-3"
          style={{ maxWidth: "18rem", border: "0", background: "transparent" }}
        >
          <div
            style={{
              borderRadius: "16px",
          ...
          >
            <div className="d-flex justify-content-around ">
              <div>
                <h2 className={`${styles.cardHeading}`}>Total Earning</h2>
                <h2 className={`${styles.cardSubheading}`}>$24,000</h2>
              </div>
              <div>
                <RiMoneyDollarCircleFill
                  size="40px"
                  style={{ color: "var(--table-font-color)" }}
                />
              </div>
            </div>
            <div className="d-flex justify-content-around">
              <h5 className={styles.cardPercentage}>
                +17.50%{" "}
                <span>
                  <FaArrowUpLong />
                </span>
              </h5>
              <p className={styles.cardparagraph}>vs. last month</p>
            </div>
          </div>
        </div>
        {/* card 2 */}
        ...
        >
          ...
          >
            <div className="d-flex justify-content-around ">
              <div>
                <h2 className={`${styles.cardHeading}`}>Total Course</h2>
                <h2 className={`${styles.cardSubheading}`}>4,000</h2>
              </div>
              <div>
                <RiMoneyDollarCircleFill
                  size="40px"
        ...
        >
          ...
          >
            <div className="d-flex justify-content-around ">
              <div>
                <h2 className={`${styles.cardHeading}`}>Total Users</h2>
                <h2 className={`${styles.cardSubheading}`}>24,000</h2>
              </div>
              <div>
                <RiMoneyDollarCircleFill
